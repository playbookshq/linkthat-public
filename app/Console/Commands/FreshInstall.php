...
{
    protected $signature = 'fresh:install {name? : The project name}';

    protected $description = 'Run the Fresh installation process';
    ...
    public function handle()
    {
        ...
        info('Fresh installation completed successfully! ☢️');
